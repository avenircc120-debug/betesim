...
import { Bell, Menu, Check, LogIn, Zap } from "lucide-react";
        ...
        <div className="grid grid-cols-3 gap-2">
          {PACKS.map((pack) => {
            ...
            return (
              ...
              >
                {pack.badge && (
                  <span className={`absolute -top-2 left-2 rounded-full px-2 py-px text-[9px] font-bold leading-tight ${pack.badgeColor}`}>
                    {pack.badge}
                  </span>
                )}
                {isSelected && (
