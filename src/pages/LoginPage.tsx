import { useState } from "react";
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col">
        {/* Top bar */}
        <div className="flex items-center justify-center gap-1 pt-14 pb-6 px-4">
                  ...
                  <Field label="Confirmer">
                    <div className="relative">
                      <input
                        ...
                        className={inputCls + " pr-9 text-xs"}
                      />
                      <button type="button" onClick={() => setShowPwd2(v => !v)} className="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400">
