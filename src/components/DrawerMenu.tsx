import { X, LayoutDashboard, Smartphone, CreditCard, User, LogOut } from "lucide-react";
...
const NAV_ITEMS = [
  { label: "Accueil",     icon: LayoutDashboard, path: "/accueil" },
  { label: "Mes numéros", icon: Smartphone,      path: "/numeros" },
  { label: "Rechargeur",  icon: CreditCard,      path: "/recharger" },
