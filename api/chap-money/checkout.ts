import type { VercelRequest, VercelResponse } from "@vercel/node";
    ...
    try {
      ...
      // Garantit l'existence du profil (FK coin_orders → profiles).
      // ensure-profile est censée le créer au login, mais si elle a échoué
      // ou n'a pas été déclenchée, cet upsert sert de filet de sécurité.
